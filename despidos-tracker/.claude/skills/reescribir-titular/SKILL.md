...
3. **Si pasa el filtro, reescribí título y bajada** en estilo de diario serio (La Nación / WSJ / NYT / FT):
   ...
   - **Sujeto del título**: el título arranca con la empresa/organismo protagonista de la noticia, no con "la Justicia [ordenó/dispuso/abrió]...". Aunque el hecho sea una decisión judicial, la empresa es el sujeto (ej: "Celulosa Argentina entró en concurso preventivo", no "La Justicia abrió el concurso de Celulosa Argentina").
